...
<?php include "UI.php";?>
  ...
  <body> 
	...
	<div class="col-md-10" style="text-align: center">
		<div class="col-md-10" style="text-align: center; font-size: 60px; color:#C0C0C0"> Employee Info </div>
		<div style="margin-left:10%; margin-right:40%; margin-top:50px; margin-bottom:50px;opacity: 0.7;text-align:center;background:#21fbab;">
...
echo '<table>';
echo '<tr><th>Employee ID</th><th>Name</th><th>Contact</th><th>Email</th><th>Address</th><th>Salary</th><th>Joining Month-Year</th></tr>';

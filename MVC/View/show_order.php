...
<?php include "UI.php";?>
  ...
  <body> 
	...
	<div class="col-md-10" style="text-align: center">
		<div class="col-md-10" style="text-align: center; font-size: 60px; color:#C0C0C0"> Order List </div>
...
echo '<table>';
echo '<tr><th>Order ID</th><th>Amount</th><th>Payment Method</th><th>Status</th></tr>';
